...
//   ];
  ...
  {
    id: 2,
    title: "Ayodhya Divine Pilgrimage Tour",
    description:
      "A sacred spiritual destination deeply rooted in Indian mythology and cultural heritage.",
    image:
      "Ayodhya.jpg",

    duration: null,
    route: "Ayodhya → Pilgrimage Sites → Cultural Tour",
    locations: ["Ayodhya"],
    ...
    combo: false,
    days: ["Arrival & Hanuman Garhi visit",
           "Ram Janmabhoomi tour & local market",
           "Cultural evening & departure",
            ],
  },
  {
    id: 3,
    title: "Ahemdabad Heritage Walk Tour",
    description:
      "Ahemdabad's rich cultural heritage and historical landmarks.",
    image: "Ahmedabad.jpg",

    duration: "3 Days / 2 Nights",
    route: "Ahemdabad → Sabarmati Ashram → Old City Walk",
    locations: ["Ahemdabad", "Sabarmati Ashram", "Old City Walk"],
    ...
    combo: true,
    days: [
      "Arrival & Ahemdabad City tour",
      "Sabarmati Ashram visit & local market exploration",
      "Old City Walk & departure",
    ],
  },
  {
    id: 4,
    title: "Bangalore Urban Explorer Getaway",
    description:
      "Bangalore's vibrant tech scene, lush greenery, and bustling markets.",
    image: "Bangalore.jpg",

    duration: "3 Days / 2 Nights",
    route: "Bangalore → Tech Parks → Markets",
    locations: ["Bangalore", "Tech Parks", "Markets"],
    ...
    combo: false,
    days: [
      "Arrival & Cubbon Park visit",
      "Tech Park tour & local cuisine experience",
      "Market exploration & departure",
    ],
  },
  {
    id: 5,
    title: "Agra Taj Mahal Golden Triangle Tour",
    description:
      "A classic tour covering the iconic monuments of Agra, Delhi, and Jaipur.",
    image: "Agra.jpg",
    duration: null,
    route: "Agra → Delhi → Jaipur",
    locations: ["Agra", "Delhi", "Jaipur"],
    price: 36999,
    discountedPrice: 29999,
    tag: "Recommended",
    badge: "Recommended",
    combo: false,
    days: [
      "Agra – Taj Mahal & Agra Fort visit",
        "Delhi – Red Fort & India Gate tour",
        "Jaipur – City Palace & Amber Fort exploration",
    ],
  },
  {
    id: 6,
    title: "Hyderabad Royal Nizam Experience",
    description:"A royal city of Nizams famous for Charminar, pearls, and world-renowned biryani.",
    image: "Hyderabad.jpg",
    duration: null,
    route: "Hyderabad → Charminar → Biryani Tasting", 
    locations: ["Hyderabad", "Charminar", "Biryani Tasting"],
    price: 49999,
    discountedPrice: 41999,
    tag: "Adventure",
    badge: "Adventure",
    combo: false,
    days: [
      "Arrival & Charminar visit", 
        "Monastery visits & local culture experience",
        "Departure & culinary delights",
    ],
  },
  {
    id: 7,
  ...
  {
    id: 8,
    title: "Kutch Desert Festival Tour",
    description:"A vibrant festival experience in the Kutch region, showcasing traditional crafts, folk dances, and desert landscapes.",
    image: "Kutch.jpg",
    duration: null,
    route: "Kutch → Rann Utsav → Desert Exploration", 
    locations: ["Kutch", "Rann Utsav", "Desert Exploration"],
    price: 39999,
    ...
    combo: false,
    days: [
      "Arrival & Rann Utsav festivities", 
        "Desert safari & cultural performances",
        "Kutch village visit & departure",
    ],
  },
];
